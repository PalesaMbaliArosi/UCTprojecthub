...
namespace UCTprojecthub.Migrations
{
    ...
    [Migration("20220908020453_ThemesSeeded")]
    partial class ThemesSeeded
    {
            ...
            modelBuilder.Entity("UCTprojecthub.Areas.Identity.Data.UCTprojecthubUser", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2022, 9, 7, 19, 4, 53, 295, DateTimeKind.Local).AddTicks(3406));
            ...
            modelBuilder.Entity("UCTprojecthub.Models.Theme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f0404ce-9c49-4f1c-b6f1-4e057e4f50c4"),
                            DateCreated = new DateTime(2022, 9, 7, 19, 4, 53, 295, DateTimeKind.Local).AddTicks(5134),
                            Description = "Information relating to real-world application eCommerce in Cape Town",
                            Title = "eCommerce"
                        },
                        new
                        {
                            Id = new Guid("8fc24d0e-aba3-4f4b-b082-8e49fe6c280c"),
                            DateCreated = new DateTime(2022, 9, 7, 19, 4, 53, 295, DateTimeKind.Local).AddTicks(5140),
                            Description = "A study involving improvements to blockchain technology",
                            Title = "Blockchain"
                        },
                        new
                        {
                            Id = new Guid("d68f72a1-986a-457e-bc2c-8ca234d7dbf0"),
                            DateCreated = new DateTime(2022, 9, 7, 19, 4, 53, 295, DateTimeKind.Local).AddTicks(5141),
                            Description = "Developments in security and the improvements to be expected in the future",
                            Title = "Security"
                        },
                        new
                        {
                            Id = new Guid("8d4a836a-d0eb-4ee6-9b82-8d4898ca9381"),
                            DateCreated = new DateTime(2022, 9, 7, 19, 4, 53, 295, DateTimeKind.Local).AddTicks(5142),
